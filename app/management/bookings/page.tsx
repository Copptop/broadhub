...
const rawBookings = [
  ...
  { id: 21, user: 'Test User', resource: 'Room 1', resourceType: "meeting room", resourceLocation: 'Marsh Wall, Canary Wharf', href: '#', startDateTime: '2024-01-21T09:00', endDateTime: '2024-01-21T17:00' },
  { id: 22, user: 'Test User', resource: 'Room 1', resourceType: "meeting room", resourceLocation: 'Marsh Wall, Canary Wharf', href: '#', startDateTime: '2024-01-21T09:00', endDateTime: '2024-01-21T17:00' },
  { id: 23, user: 'Test User', resource: 'Room 1', resourceType: "meeting room", resourceLocation: 'Marsh Wall, Canary Wharf', href: '#', startDateTime: '2024-01-21T09:00', endDateTime: '2024-01-21T17:00' },
  { id: 24, user: 'Test User', resource: 'Room 3', resourceType: "meeting room", resourceLocation: 'Marsh Wall, Canary Wharf', href: '#', startDateTime: '2024-01-21T09:00', endDateTime: '2024-01-21T17:00' },
  { id: 25, user: 'Test User', resource: 'Room 2', resourceType: "meeting room", resourceLocation: 'Marsh Wall, Canary Wharf', href: '#', startDateTime: '2024-01-21T09:00', endDateTime: '2024-01-21T17:00' },
