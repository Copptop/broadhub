...
export default function WorldMap() {
  ...
  return (
    <>
      <svg ref={svgRef} id="map" width="100%" height="100%" viewBox="0 0 368 219" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <Link className='MapSelectable' href='EMEA/Paris'>
              <g id="Paris" transform="matrix(1,0,0,1,-61.5005,-51.9689)">
                ...
                <g transform="matrix(1,0,0,1,-6.34356,-0.00264457)">
                  ...
                  <text x="181.575px" y="173.13px" font-family="ArialMT, Arial, sans-serif"
                    font-size="5.416px">Paris</text>
                </g>
              </g>
            </Link>
            <Link className='MapSelectable' href='EMEA/Frankfurt' >
              <g id="Frankfurt" transform="matrix(1,0,0,1,-24.9818,-63.8641)">
                ...
                <g transform="matrix(1,0,0,1,-6.34356,-0.00264457)">
                  ...
                  <text x="176.91px" y="173.13px" font-family="ArialMT, Arial, sans-serif"
                    font-size="5.416px">Frankfurt</text>
                </g>
              </g>
            </Link>
            <Link className='MapSelectable' href='EMEA/Prague'>
              <g id="Prague" transform="matrix(1,0,0,1,0.559475,-67.6522)">
                ...
                <g transform="matrix(1,0,0,1,-6.34356,15.9974)">
                  ...
                  <text x="179.012px" y="173.13px" font-family="ArialMT, Arial, sans-serif"
                    font-size="5.416px">Prague</text>
                </g>
              </g>
            </Link>
            <Link className='MapSelectable' href='EMEA/Cluj'>
              <g id="Cluj" transform="matrix(1,0,0,1,48.3995,-44.3342)">
                ...
                <g transform="matrix(1,0,0,1,-6.34356,15.9974)">
                  ...
                  <text x="183.08px" y="173.13px" font-family="ArialMT, Arial, sans-serif"
                    font-size="5.416px">Cluj</text>
                </g>
              </g>
            </Link>
            <Link className='MapSelectable' href='EMEA/Berlin'>
              <g id="Berlin" transform="matrix(1,0,0,1,-10.3745,-81.9737)">
                ...
                <g transform="matrix(1,0,0,1,-6.34356,-0.00264457)">
                  ...
                  <text x="180.821px" y="173.13px" font-family="ArialMT, Arial, sans-serif"
                    font-size="5.416px">Berlin</text>
                </g>
              </g>
            </Link>
            <Link className='MapSelectable' href='EMEA/Gdansk'>
              <g id="Gdansk" transform="matrix(1,0,0,1,15.1667,-91.2323)">
                ...
                <g transform="matrix(1,0,0,1,-6.34356,-0.00264457)">
                  ...
                  <text x="178.412px" y="173.13px" font-family="ArialMT, Arial, sans-serif"
                    font-size="5.416px">Gdansk</text>
                </g>
              </g>
            </Link>
            <Link className='MapSelectable' href='EMEA/Stockholm'>
              <g id="Stockholm" transform="matrix(1,0,0,1,3.85063,-125.523)">
                ...
                <g transform="matrix(1,0,0,1,-6.34356,-0.00264457)">
                  ...
                  <text x="175.102px" y="173.13px" font-family="ArialMT, Arial, sans-serif"
                    font-size="5.416px">Stockholm</text>
                </g>
              </g>
            </Link>
          </g>
