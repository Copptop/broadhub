  ...
  return (
    <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-zinc-200 dark:border-zinc-900 bg-white dark:bg-zinc-800 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
      ...
      <div className="flex-grow flex-shrink-0">
        <div className="flex">
          <div className="relative w-full rounded-md bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-600 focus-within:ring-0">
            <input
              id="search"
              name="search"
              className="block w-full h-full border-transparent pl-4 pr-3 py-2 rounded-md bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-600  text-zinc-900 placeholder-zinc-500 dark:text-zinc-300 dark:placeholder-zinc-400 focus:outline-none focus:ring-0 focus:border-transparent sm:text-sm"
              placeholder="Search"
              type="search"
            />
          </div>
      ...
      <button
        type="button"
        className="text-zinc-500 rounded-md hover:text-zinc-800 dark:hover:text-zinc-300 focus:outline-none"
                ...
                {({ active }) => (
                  <a
                    ...
                    className={twMerge(
                      ...
                      'block px-3 py-1 text-sm leading-6 text-zinc-800 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 rounded-md'
                    )}
                  >
                    {item.name}
                  </a>
